...
export function Sidebar() {
  ...
  return (
    <aside className={`absolute left-0 top-0 z-50 flex h-screen w-[18rem] flex-col overflow-y-hidden bg-[#f5f5f5] duration-300 ease-linear ${currtState ? "w-[18rem]" : "w-[80px]"} `}>
