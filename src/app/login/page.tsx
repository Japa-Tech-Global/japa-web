    ...
    <>
      ...
      <main className="grid lg:grid-cols-2 h-screen gap-16 w-full">
        ...
        <div className="flex flex-1 flex-col justify-center items-center lg:items-start">
          ...
          <form
            className="pt-2 text-xs w-[80vw] sm:w-[60vw] md:w-[40vw]"
            onSubmit={(e) => handleSubmit(e)}
          >
            <div className="pt-5">
              <p className="text-left pb-1 font-medium">Email Address</p>
              <input
                className="w-full p-3 border border-txtinput rounded-[5px]"
                value={email}
            ...
            <div className="pt-5">
              ...
              <p className="text-right pt-1">
                <Link href="#" className="text-primary font-medium mb-2">
                  Forgot Password?
                </Link>
              </p>
            </div>
            ...
            <button
              className={`bg-primary text-white w-full mt-5 py-3 rounded-[5px] px-4 font-semibold ${
                loading && "opacity-30"
              }`}
